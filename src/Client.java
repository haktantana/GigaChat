...
public Client() {
	    ...
	    name=startScreen.showInputDialog(null,"Enter your name:","GigaChat",JOptionPane.PLAIN_MESSAGE);
		addr=startScreen.showInputDialog(null,"Enter the IP address:","GigaChat",JOptionPane.PLAIN_MESSAGE);
			try {
				InetAddress iA=InetAddress.getByName(addr);
				s = new Socket (iA,6868);
...
private void CreateGui() {
	...
	Icon messangerIcon=new ImageIcon("C:\\Users\\HAKTAN\\eclipse-workspace\\ChatAppWithGui\\assets\\messangerIcon.png");
